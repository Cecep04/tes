                                    ...
                                    <div class="carousel-item active">
                                        <div>
                                            ...
                                            <p data-animation="animated slideInRight" data-delay="1s">
                                                Aplikasi Penerimaan Peserta didik baru Tahun Pelajaran 2023/2024 <?= $setting['nama_sekolah'] ?>.
                                            </p>
                                            <p data-animation="animated slideInRight" data-delay="2s">
                                                Pendaftaran Siswa dan Siswi Baru Tahun 2023 ini telah dibuka. Silahkan Segera Daftar dan lengkapi Formulir
                                            </p>
						...
						<div class="col-sm-8">
                                    ...
                                    <div class="carousel-item active">
                                        <div>
                                            ...
                                            <p data-animation="animated slideInRight" data-delay="2s">
                                                Pendaftaran Siswa dan Siswi Baru Tahun 2023-2024 ini Belum Dibuka.
                                            </p>
                                            <p data-animation="animated flipInX" data-delay="3s">
...
<?php } ?>
                 <section class="bg-light statistik" id="persyaratan">
                    <div class="container">
                        ...
                        <h6 class="text-center">Peserta Didik Baru <?= $setting['nama_sekolah'] ?> Tahun 2023-2024</h6>
                        <div class="row mt-12">
                            <div class="col-sm-6">
                                <div class="card mt-2">
