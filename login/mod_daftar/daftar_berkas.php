                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
									 <?php if ($daftar['ktp'] <> null) { ?><a data-toggle="tooltip" data-placement="top" title="" data-original-title="KTP Orangtua" href="../<?= $daftar['ktp'] ?>" class="btn btn-sm btn-primary"><i class="fas fa-envelope    "></i></a><?php } ?> 
                                    </td>
