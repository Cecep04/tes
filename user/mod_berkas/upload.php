    ...
    <div class="card" id="berkas-card">
        ...
        <div class="card-body">
           ...
           <div class="form-group row align-items-center">
            ...
            <div class="form-group row align-items-center">
                <label class="form-control-label col-sm-3 text-md-right">KTP Orangtua</label>
                <div class="col-sm-6 col-md-9">

                    <div class="custom-file">
                        <input type="file" name="ktp" class="custom-file-input" id="site-ktp">
                        <label class="custom-file-label">Choose File</label>
                    </div>
                    <div class="form-text text-muted">The image must have a maximum size of 1MB</div>
                </div>
			...
			<div class="form-group row align-items-center">
                <label class="form-control-label col-sm-3 text-md-right">Preview</label>
                <div class="col-sm-6 col-md-6">
                    <img src="../<?= $siswa['ktp'] ?>" class="img-thumbnail" width="50%">
                </div>
            </div>
